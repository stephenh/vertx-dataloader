...
public class DataLoaderTest {
    ...
    @Test
    public void should_Build_a_really_really_simple_data_loader(TestContext t) {
    ...
    @Test
    public void should_Support_loading_multiple_keys_in_one_call(TestContext t) {
        DataLoader<Integer, Integer> identityLoader = new DataLoader<>(keys ->
          Future.succeededFuture(new ArrayList<>(keys)));
    ...
    @Test
    public void should_Resolve_to_empty_list_when_no_keys_supplied(TestContext t) {
    ...
    @Test
    public void should_Batch_multiple_requests(TestContext t) {
    ...
    @Test
    public void should_Coalesce_identical_requests(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoader<Integer, Integer> identityLoader = idLoader(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Cache_repeated_requests(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
    ...
    @Test
    public void should_Not_redispatch_previous_load(TestContext t) {
      ArrayList<Collection> loadCalls = new ArrayList<>();
      DataLoader<String, String> identityLoader = idLoader(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Cache_on_redispatch(TestContext t) {
      ArrayList<Collection> loadCalls = new ArrayList<>();
      DataLoader<String, String> identityLoader = idLoader(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Clear_single_value_in_loader(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoader<String, String> identityLoader = idLoader(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Clear_all_values_in_loader(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoader<String, String> identityLoader = idLoader(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Allow_priming_the_cache(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoader<String, String> identityLoader = idLoader(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Not_prime_keys_that_already_exist(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoader<String, String> identityLoader = idLoader(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Allow_to_forcefully_prime_the_cache(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoader<String, String> identityLoader = idLoader(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Cache_failed_fetches(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
    ...
    @Test
    public void should_Handle_priming_the_cache_with_an_error(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoader<Integer, Integer> identityLoader = idLoader(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Clear_values_from_cache_after_errors(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoader<Integer, Integer> errorLoader = idLoaderAllErrors(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Propagate_error_to_all_loads(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoader<Integer, Integer> errorLoader = idLoaderAllErrors(new DataLoaderOptions(), loadCalls);
    ...
    @Test
    public void should_Accept_objects_as_keys(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
    ...
    @Test
    public void should_Disable_caching(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
    ...
    @Test
    public void should_Accept_objects_with_a_complex_key(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
    ...
    @Test
    public void should_Clear_objects_with_complex_key(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoaderOptions options = DataLoaderOptions.create().setCacheKeyFunction(getJsonObjectCacheMapFn());
        DataLoader<JsonObject, JsonObject> identityLoader = idLoader(options, loadCalls);
    ...
    @Test
    public void should_Accept_objects_with_different_order_of_keys(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoaderOptions options = DataLoaderOptions.create().setCacheKeyFunction(getJsonObjectCacheMapFn());
        DataLoader<JsonObject, JsonObject> identityLoader = idLoader(options, loadCalls);
    ...
    @Test
    public void should_Allow_priming_the_cache_with_an_object_key(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
        DataLoaderOptions options = DataLoaderOptions.create().setCacheKeyFunction(getJsonObjectCacheMapFn());
        DataLoader<JsonObject, JsonObject> identityLoader = idLoader(options, loadCalls);
    ...
    @Test
    public void should_Accept_a_custom_cache_map_implementation(TestContext t) {
    ...
    @Test
    public void should_Batch_loads_occurring_within_futures(TestContext t) {
        ArrayList<Collection> loadCalls = new ArrayList<>();
